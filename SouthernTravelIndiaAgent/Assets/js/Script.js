...
******************************************************************************************************/
		...
		{	
			...
			pp.document.writeln('<HTML><HEAD><title>Print Preview</title><LINK href=tmsStyle.css  type="text/css" rel="stylesheet">')
			pp.document.writeln('<LINK href=Include/PrintStyle.css  type="text/css" rel="stylesheet" media="print"><base target="_self"></HEAD>')
			//Adding Body Tag
