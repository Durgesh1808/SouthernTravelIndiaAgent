...
namespace SouthernTravelIndiaAgent
{
     ...
     */
        ...
        */
         ...
         * @return JSON string
        */
        private string api_call(string method, string path, object PostData)
        {
        ...
        */
        public CreatePaymentOrderResponse createNewPaymentRequest(PaymentOrder objPaymentRequest)
        {
            ...
            CreatePaymentOrderResponse objPaymentCreateResponse = null;
            if (isInValid)
            {
            ...
            try
            {
                ...
                objPaymentCreateResponse = JsonDeserialize<CreatePaymentOrderResponse>(stream);
        ...
        */
        public PaymentOrderListResponse getPaymentOrderList(PaymentOrderListRequest objPaymentOrderListRequest)
        {
            ...
            PaymentOrderListResponse objPaymentRequestStatusResponse = null;
            ...
            try
            {
                ...
                objPaymentRequestStatusResponse = JsonDeserialize<PaymentOrderListResponse>(stream);
        ...
        public PaymentOrderDetailsResponse getPaymentOrderDetails(string strOrderId)
        {
            ...
            try
            {
                ...
                objPaymentRequestDetailsResponse = JsonDeserialize<PaymentOrderDetailsResponse>(stream);
                return objPaymentRequestDetailsResponse;
            }
            catch (IOException ex)
            {
        ...
        */
        ...
        {
            CreateRefundResponce objRefundResponse = null;
            ...
            try
            {
                ...
                objRefundResponse = JsonDeserialize<CreateRefundResponce>(stream);
