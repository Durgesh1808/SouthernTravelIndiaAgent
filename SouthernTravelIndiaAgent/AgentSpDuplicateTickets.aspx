<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentSpDuplicateTickets.aspx.cs" Inherits="SouthernTravelIndiaAgent.AgentSpDuplicateTickets" %>
                            ...
                            <td valign="top" bgcolor="#ffffff">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr style="background-color: #348DE7; height: 30px;">
                                        ...
                                        <td>
                                            <input name="txtjdate" type="text" readonly="readonly" class="verdana11bk" runat="server"
                                    ...
                                    <tr>
                                        <td colspan="5" valign="top">
                                            ...
                                            <asp:DataGrid ID="dgspDuplicateTickets" runat="server" Width="100%" CssClass="verdana11bk"
                                                DataKeyField="rowid" AutoGenerateColumns="False" OnPageIndexChanged="dgspDuplicateTickets_PageIndexChanged"
                                                PageSize="20" AllowPaging="true" OnItemDataBound="dgspDuplicateTickets_ItemDataBound"
                                                OnSelectedIndexChanged="dgspDuplicateTickets_SelectedIndexChanged">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="Ticket code">
                                                        <HeaderStyle HorizontalAlign="Center" Width="15%"></HeaderStyle>
                                                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                        <ItemTemplate>
                                                            <a href="AgentSpltourTicket.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"rowid") %>&Ticket=kps">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="Group Leader">
                                                        ...
                                                        <ItemStyle HorizontalAlign="left"></ItemStyle>
                                                        <ItemTemplate>
                                                            <asp:Label ID="Groupleader" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"groupleader") %>'>
                                                            </asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
