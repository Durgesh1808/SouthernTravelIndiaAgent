<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentSpecialTourCancellation.aspx.cs" Inherits="SouthernTravelIndiaAgent.AgentSpecialTourCancellation" %>
...
{  
   ...
   if(document.form1.txtjdate.value=="")
	{
        alert("Please select the Journeydate:");
...
function Left(str, n)
{
    ...
    <style type="text/css">
        #print_area (
        display: list-item; list-style-image: url('Images /
        tcancel.gif'); list-style-position: inside;}}}</style>
</head>
<body>
    ...
    <table style="width: 100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td>
                <uc1:AgentHeader ID="BranchHeader" runat="server" />
            </td>
        </tr>
        <tr>
                            ...
                            <table id="Table2" style="border-color: #fff0ca; background-color: #ffffff" cellspacing="0"
                                ...
                                <tr>
                                    <td style="height: 25px; background-color: #5aa1ea" align="center">
                                        <b class="cgi1">You can&nbsp;&nbsp;cancel &nbsp;your tours&nbsp;&nbsp;by Ticket No and
                                    ...
                                    <td style="width: 100%;">
                                        <table id="Table3" style="background-color: #9bc7f4" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox CssClass="hlinks" ID="txtpNRo" runat="server" Width="168px"></asp:TextBox>
                                                </td>
                                                <td class="cgi1" align="right">
                                                    Email-ID / Mobile No:&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="hlinks" style="height: 23px">
                                                    <input id="txtjdate" readonly="readonly" name="txtjdate" type="text" runat="server"
                                                ...
                                                <td align="center">
                                                    <div id="print_area">
                                                        <table style="border-color: #000000;" cellspacing="0" cellpadding="1" width="100%"
                                                            ...
                                                            <tr>
                                                                <%--<td align="center">
                                                                        <img runat="server" id="imglogo" border="0" /></td>--%>
                                                                <td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="69%">
                                                                                            <font color="#666666" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                                                                                                <img id="agentimg" runat="server" width="157" height="69" alt="" /><br />
                                                                                                <asp:Label ID="agtaddress" runat="server"></asp:Label></font>
                                                                                        </td>
                                                                                        <td width="31%" valign="top">
                                                                                            <img id="southernimg" runat="server" width="231" height="64" alt="" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <%
                                                                        ...
                                                                        {
                                                                    %>
                                                                    <table cellspacing="0" cellpadding="3" width="100%" border="1" background="Assets/images/tcancel.gif">
                                                                        <%}
                                                                            else
                                                                            {%>
                                                                        <table cellspacing="0" cellpadding="3" width="100%" border="1" style="background-color: #DDEEFF;">
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" colspan="2">
                                                                                    <span class="cgi">Tour Name:</span>&nbsp;<span class="hlinks"><asp:Label ID="lblTourName"
                                                                                        runat="server"></asp:Label></span>
                                                                                </td>
                                                                                <td align="left">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="left">
                                                                                    <span class="cgi">
                                                                                        ...
                                                                                        No:</span>&nbsp;<span class="hlinks"><asp:Label ID="lblDropNo" runat="server"></asp:Label></span>
                                                                                </td>
                                                                                <td align="left" colspan="2">
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" style="width: 25%;">
                                                                                    <span class="cgi">Name:</span>&nbsp;
                                                                                </td>
                                                                                <td align="left" style="width: 55%;" colspan="3">
                                                                                    <span class="cgi">Address:</span>&nbsp;
                                                                                </td>
                                                                                <td align="left" style="width: 20%;">
                                                                                    <span class="cgi">No of Pax/Single Sharing:</span>&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="left">
                                                                                ...
                                                                                <td align="left">
                                                                                    <span class="hlinks">
                                                                                        <asp:Label ID="lblPax" runat="server"></asp:Label></span>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="left" colspan="2">
                                                                                ...
                                                                                <td align="left">
                                                                                    <span class="cgi">
                                                                                        <asp:Label ID="lblDiscount" runat="server"></asp:Label></span>&nbsp;<span class="hlinks"><asp:Label
                                                                                            ID="lbldiscount1" runat="server"></asp:Label></span>
                                                                                </td>
                                                                                <td align="left" colspan="2">
                                                                                    <span class="cgi">GST :</span><span class="hlinks">
                                                                                        <asp:Label ID="lblServiceTax" runat="server"></asp:Label></span>
                                                                                </td>
                                                                            </tr>
                                                                            <tr id="trTicketView" runat="server" colspan="2">
                                                                                <td align="left" colspan="2">
                                                                                    <span class="cgi">Total Amount: </span><span class="hlinks">
                                                                                        <asp:Label ID="lblTotalAmount" runat="server"></asp:Label></span>
                                                                                </td>
                                                                                <td align="left">
                                                                                    <span class="cgi">Advance Amount: </span><span class="hlinks">
                                                                                        <asp:Label ID="lblAdvance" runat="server"></asp:Label></span>
                                                                                </td>
                                                                                <td align="left" colspan="2">
                                                                            ...
                                                                            <tr id="trCancelView" runat="server">
                                                                                <td align="left" id="AdvanceHide" runat="server">
                                                                                    <span class="cgi">Advance Amount: </span><span class="hlinks">
                                                                                        <asp:Label ID="lblAdvance1" runat="server"></asp:Label></span>
                                                                                </td>
                                                                                <td align="left" colspan="2">
                                                                                ...
                                                                                <td align="left" colspan="2">
                                                                                    <span class="cgi">
                                                                                        <asp:Label ID="lblrefund" runat="server"></asp:Label></span>&nbsp;<span class="hlinks"><asp:Label
                                                                                            ID="lblRefundAmount" runat="server"></asp:Label></span>
                                                                                </td>
                                                                                <td align="left" id="BalanceHide" runat="server">
                                                                                    <span class="cgi"></span>
                                                                                </td>
                                                                            </tr>
                                                                            <tr id="trCancelView1" runat="server">
                                                                                <td align="left" colspan="2">
                                                                                    <span class="cgi">Cancellation Charge:</span>&nbsp;<span class="hlinks"><asp:Label
                                                                                        ID="lblCancellationCharge1" runat="server"></asp:Label></span>
                                                                                </td>
                                                                                <td align="left" colspan="3">
                                                                                    <span class="cgi">
                                                                                        <asp:Label ID="lblrefund1" runat="server"></asp:Label></span>&nbsp;<span class="hlinks"><asp:Label
                                                                                            ID="lblRefundAmount1" runat="server"></asp:Label></span>
                                                                                </td>
                                                                            </tr>
                                                                            <!--New Row-->
                                                                            <tr id="trTicketView1" runat="server">
                                                                                <td align="left" colspan="2">
                                                                                    <span class="cgi">
                                                                                        <asp:Label ID="lblbookingbranch" runat="server"></asp:Label>
                                                                                    </span><span class="hlinks">
                                                                                        <asp:Label ID="lblBranchCode" runat="server"></asp:Label></span>
                                                                                </td>
                                                                                <td align="left" colspan="3">
                                                                                    <span class="cgi">Payment Mode: </span><span class="hlinks">
                                                                                        <asp:Label ID="lblPaymentMode" runat="server"></asp:Label></span>
                                                                                </td>
                                                                            </tr>
                                                                            <!--New Row-->
                                                                        </table>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <p class="hlinks" style="margin-left: 0.3in">
                                                                    <font size="5"><b>·</b></font>&nbsp; Before 7 clear days of the journey date : 50%
                                                                    <br />
                                                                    <font size="5"><b>·</b></font>&nbsp; Within 7 days of the Journey date : No refund.
                                                                </p>
                                                                <p class="cgi">
                                                                    <b>2. PHOTO ID</b>
                                                                </p>
