<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentHotelAccDuplicateTicket.aspx.cs" Inherits="SouthernTravelIndiaAgent.AgentHotelAccDuplicateTicket" %>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" bgcolor="#ffffff">
                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                    ...
                                                                    <table width="350" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td background="Assets/images/bg1.gif" class="verdana14w">
                                                                                Agent Accommodation Duplicate Ticket
                                                                            </td>
                                                ...
                                                <tr>
                                                    <td align="right" class="style2" colspan="6">
                                                           ...
                                                           AllowPaging="true" PageSize="20" 
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="PNR Number">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <a href="Hotel_Reciept.aspx?orderid=<%#DataBinder.Eval(Container.DataItem,"OrderId") %>&duplicate=htdup">
                                                                ...
                                                                <asp:BoundColumn DataField="arrtime" DataFormatString="{0:dd/MM/yyyy}" HeaderText="CheckIn Date">
                                                                    <ItemStyle Width="11%" HorizontalAlign="Left" />
                                                                </asp:BoundColumn>
                                                                <asp:BoundColumn DataField="BookingDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Booking Date">
                                                                    <ItemStyle Width="15%" HorizontalAlign="Left" />
                                                                </asp:BoundColumn>
                                                               
                                                                <asp:BoundColumn  HeaderText="Hotel Rooms">
                                                                    <ItemStyle Width="15%" HorizontalAlign="Left" />
                                                                </asp:BoundColumn>
                                                               
                                                               <%-- <asp:BoundColumn DataField="noofrooms" HeaderText="No of Rooms">
