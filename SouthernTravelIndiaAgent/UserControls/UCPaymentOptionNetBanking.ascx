<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCPaymentOptionNetBanking.ascx.cs" Inherits="SouthernTravelIndiaAgent.UserControls.UCPaymentOptionNetBanking" %>
