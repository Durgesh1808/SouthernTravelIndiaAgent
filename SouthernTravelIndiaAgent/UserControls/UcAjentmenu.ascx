<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcAjentmenu.ascx.cs" Inherits="SouthernTravelIndiaAgent.UserControls.UcAjentmenu" %>
   ...
   <asp:Menu ID="Menu1" runat="server" CssClass="MainMenu" EnableTheming="True" 
                 ...
                 StaticSubMenuIndent="46px" Width="400">
                 ...
                 <Items>
                     <asp:MenuItem NavigateUrl="~/Agent/agenthomepage.aspx" Text="Home" Value="Home">
                     </asp:MenuItem>
                     <asp:MenuItem Text="|" Value="|"></asp:MenuItem>
                     <asp:MenuItem Text="Bookings" Value="Bookings">
                         <asp:MenuItem Text="Tour Packages" Value="Tour Packages">
                             <asp:MenuItem NavigateUrl="~/Agent/agenthomepage.aspx?pmode=tour" 
                                 Text="Fixed Tours" Value="Fixed Tours"></asp:MenuItem>
                             <asp:MenuItem NavigateUrl="~/Agent/AgentSplPackageTours.aspx" 
                                 Text="Special Package" Value="Special Package"></asp:MenuItem>
                             <asp:MenuItem NavigateUrl="~/Agent/GroupBookingRequestForm.aspx" 
                                 Text="Group Booking" Value="Group Booking"></asp:MenuItem>
                         </asp:MenuItem>
                         <asp:MenuItem Text="Car Booking" Value="Car Booking" 
                             NavigateUrl="~/AGent/agenthomepage.aspx?pmode=car">
                         </asp:MenuItem>
                         <asp:MenuItem NavigateUrl="~/Agent/AgentHotelBooking.aspx" 
                     ...
                     <asp:MenuItem Text=" Cancellation" Value="Cancellation">
                         <asp:MenuItem NavigateUrl="~/Agent/AgentCancellation.aspx" Text="Fixed Tours" 
                             Value="Fixed Tours"></asp:MenuItem>
                         <asp:MenuItem NavigateUrl="~/Agent/AgentSpecialTourCancellation.aspx" 
                             Text="Special Package" Value="BranchSpecialTourCancellation"></asp:MenuItem>
                         <asp:MenuItem NavigateUrl="~/Agent/AgentCarCancellation.aspx" 
                         ...
                         <asp:MenuItem NavigateUrl="~/Agent/AccommodationCancellation.aspx" 
                             Text="Accomodation Cancellation" Value="Accomodation Cancellation">
                         </asp:MenuItem>
                     </asp:MenuItem>
                     <asp:MenuItem Text="|" Value="|"></asp:MenuItem>
                     <asp:MenuItem NavigateUrl="~/Agent/AgentBalanceClearence.aspx" Text="Balance Clearance" Value="Balance">
                     </asp:MenuItem>
                     <asp:MenuItem Text="|" Value="|"></asp:MenuItem>
                     <asp:MenuItem Text="Duplicate Tickets" Value="Duplicate Tickets">
                         <asp:MenuItem NavigateUrl="~/Agent/AgentDuplicateTicket.aspx" 
                             Text="Fixed Tours" Value="Fixed Tours"></asp:MenuItem>
                         <asp:MenuItem NavigateUrl="~/Agent/Agentspduplicatetickets.aspx" 
                             Text="Special Package" Value="SpecialPackage"></asp:MenuItem>
                         <asp:MenuItem NavigateUrl="~/Agent/AgentcarDuplicateTicket.aspx" 
                             Text="Car Booking" Value="CarBooking"></asp:MenuItem>
                         <asp:MenuItem NavigateUrl="~/Agent/AgentHotelAccDuplicateTicket.aspx" 
                  ...
                  <%--    <asp:MenuItem Text="|" Value="|"></asp:MenuItem>
                    <asp:MenuItem 
                     ...
                     <asp:MenuItem 
                         ...
                         <asp:MenuItem NavigateUrl="~/Agent/agentviewreports.aspx" 
                             Text="Agent Commission" Value="agentviewreports"></asp:MenuItem>
                         <asp:MenuItem NavigateUrl="~/Agent/agenttransactiondetails.aspx" 
