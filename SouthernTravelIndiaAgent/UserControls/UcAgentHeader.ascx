...
<table width="1002" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td width="426">
            <img src="Assets/images/header1.jpg" width="426" height="155" />
        </td>
                ...
                <tr>
                    <td>
                        <a href="AgentProfilePage.aspx">
                            <img src="Assets/images/edit_profile.jpg" width="75" height="18" border="0" /></a>&nbsp;<a
                                href="AgentLogout.aspx"><img src="Assets/images/signout.jpg" width="53" height="18" border="0" /></a>
                    </td>
                    <td>
                        &nbsp;
                    </td>
    ...
    <tr>
        <td colspan="3">
            <table width="1002" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="14">
                        <img src="Assets/images/left_curve.jpg" width="14" height="27" />
                    </td>
                    ...
                    <td width="15">
                        <img src="Assets/images/right_curve.jpg" width="15" height="27" />
                    </td>
                </tr>
            </table>
        </td>
